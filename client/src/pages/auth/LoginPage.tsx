          ...
          <div className="mx-auto flex w-full max-w-xl flex-col justify-center">
            ...
            <div className="mt-6">
              ...
              <p className="mt-3 text-sm leading-6 text-slate-400">
                Manage issues, monitor progress, and keep your workflow clean with
                a modern issue tracking experience built for speed and clarity.
              </p>
            </div>
          ...
          <div className="w-full max-w-md rounded-3xl border border-slate-200 bg-white p-6 shadow-xl sm:p-8 xl:max-w-lg xl:p-10">
            <div className="mb-8 space-y-2 text-center">
              ...
              <p className="text-sm leading-6 text-slate-600">
                Sign in to continue to your issue dashboard
              </p>
            </div>
